	...
	<div class="col-xs-12">
		<form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" class="signup form-group">
			...
			<div class="form-control">
				...
				<input type="email" class="input-phchat" name="email" placeholder="Email" required/>
			</div>
			<div class="form-control">
				<input type="password" class="input-phchat" name="password" placeholder="Password" required />
			</div>
