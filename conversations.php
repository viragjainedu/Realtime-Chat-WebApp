...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top header-top" style="background-color: #292b2c !important;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="form-inline my-2 my-lg-0">
		...
		<form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" >
			<button type="submit" name="group" class="btn btn-phchat-logout btn-sm" style="margin-right: 40px;">Group</button>
		</form>
    	<form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST">
    		<button type="submit" name="bot" class="btn btn-phchat-logout btn-sm" style="margin-right: 40px;">BOT</button>
    	</form>
